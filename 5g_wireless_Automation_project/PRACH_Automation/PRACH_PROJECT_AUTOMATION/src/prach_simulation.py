import random
import json                 # here generate the report on the json format 
import matplotlib           # Draw the graph for visualization the result
matplotlib.use('Agg')       # Use non-GUI backend to avoid tkinter errors
import matplotlib.pyplot as plt
import socket               # check the network connectivity
from dataclasses import dataclass
from typing import List
import os          # this is handling directory path and it's helpe to save the report exiting path 
...
'''
Contention-Free Based Random Access (CFBRA)

This is a wireless communication method and this allocates random access resource to user (UE), 
and this is also provide specific preamble to user and collision does not happened. in this happened low latency. 
'''